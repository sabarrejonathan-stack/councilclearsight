 ...
 *   Proof strip — real numbers (10,511 · 4,174 · 100 · 5 days)
...
const PROOF = [
  ...
  { n: "4,174",  label: "fully verified",              sub: "scored end-to-end with click-through evidence on file" },
...
export default function Home() {
  useSEO({
    ...
    description: "The independent transparency score for every parish, town and community council in England. 10,511 councils, 14 statutory indicators, 4,174 verified end-to-end. Free to view. Gold £349/yr · Platinum £499/yr.",
    canonicalPath: "/",
  });
  return (
    <PublicLayout>
        ...
        <div className="container max-w-6xl py-20 lg:py-28">
          <div className="max-w-3xl">
            ...
            <p className="text-lg lg:text-xl text-white/80 leading-relaxed max-w-2xl mb-8">
              The independent transparency score for every parish, town, city and community council in England. 10,511 councils. 14 things the law already requires them to publish. One score residents and auditors can trust — and 4,174 already verified end-to-end with click-through evidence.
            </p>
            <CouncilSearchBar />

...
export default function Directory() {
  useSEO({
    ...
    description: "Search 10,511 parish, town, city and community councils in England. 4,500 fully verified to date — every claim links to evidence on the council's own website.",

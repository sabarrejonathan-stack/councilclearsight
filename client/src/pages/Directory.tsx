...
export default function Directory() {
  useSEO({
    ...
    description: "Search 11,057 parish, town, city and community councils in England. 4,323 fully verified to date — every claim links to evidence on the council's own website.",

        ...
        <section>
          ...
          <div className="space-y-2.5">
            {[
              ...
              { range: "—",         name: "Under Audit",      colour: "sky",     body: "Council ClearSight tracks every council in England (10,511 in total). Councils marked Under Audit are in our queue but not yet fully verified — 4,476 are verified to date, with ~200 newly-verified each week. We never publish a score before verification." },
            ].map((b) => (

...
const GROUPS = [
  {
    ...
    features: [
      { label: "The VDTI score", body: "A single 0–100 score per council. Same for every viewer." },
  ...
  {
    icon: Sparkles,
    title: "Active improvement & engagement (Platinum tier)",
    body: "Platinum is automation-led: a continuously refreshed dashboard, automated guidance, and templates that make publishing feel like engagement.",
    features: [
      ...
      { label: "Help centre + score challenge form", body: "Self-serve guidance library. We aim to acknowledge enquiries within two working days." },
    ],
  },
  {
    icon: Flag,

 ...
 * England. Of those, ~1,682 have a fully verified score (every claim linked
          ...
          <div className="bg-sky-50 border-2 border-sky-200 rounded-xl p-5">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 text-sm text-sky-950 leading-relaxed">
                ...
                When we publish a verified score for this council, every claim will link to a public document on the council's own domain — the same standard used for our 1,682 already-verified councils.
              </div>
            </div>
          </div>
        </div>

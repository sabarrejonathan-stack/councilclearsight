 ...
 * England. Of those, ~4,323 have a fully verified score (every claim linked
          ...
          <div className="flex flex-wrap items-start gap-6 mb-6">
            ...
            <div className="relative w-[150px] h-[150px] flex items-center justify-center rounded-2xl bg-sky-50 border border-sky-200">
              <div className="text-center px-3">
                ...
                <div className="text-[10px] text-sky-700/80 mt-0.5">VDTI v4.0</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-sky-50 border-2 border-sky-200 rounded-xl p-5">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 text-sm text-sky-950 leading-relaxed">
                ...
                We track every parish, town, city and community council in England — 11,057 in total. {hasUrl
                ...
                When we publish a verified score for this council, every claim will link to a public document on the council's own domain — the same standard used for our 4,323 already-verified councils.
              </div>
            </div>
          </div>
        </div>
        ...
        <aside className="space-y-6">
          ...
          <Card className="p-5 bg-primary text-white">
            ...
            <p className="text-xs text-white/75 leading-relaxed mb-4">
              4,323 councils verified to date. 6,734 remaining. Every audit produces a click-through evidence pack — pinned to public documents, never invented.
            </p>

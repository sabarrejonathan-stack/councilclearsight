 ...
 * England. Of those, ~4,160 have a fully verified score (every claim linked
          ...
          <div className="bg-sky-50 border-2 border-sky-200 rounded-xl p-5">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 text-sm text-sky-950 leading-relaxed">
                ...
                When we publish a verified score for this council, every claim will link to a public document on the council's own domain — the same standard used for our 4,160 already-verified councils.
              </div>
            </div>
          </div>
        </div>
        ...
        <aside className="space-y-6">
          ...
          <Card className="p-5 bg-primary text-white">
            ...
            <p className="text-xs text-white/75 leading-relaxed mb-4">
              4,160 councils verified to date. 6,351 remaining. Every audit produces a click-through evidence pack — pinned to public documents, never invented.
            </p>
